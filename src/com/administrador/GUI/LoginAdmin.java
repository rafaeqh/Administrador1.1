...
public class LoginAdmin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!this.jTextFieldCorreo.getText().isEmpty() && !this.jPasswordField1.getText().isEmpty()){
     ...
     * @param contra
     * @return boolean
     * Permite el login del administrador en el sistema, retorna un booleano si el login fue exitoso o no
     */
